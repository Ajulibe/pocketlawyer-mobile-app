export enum ROUTES {
  //Auth flow
  AUTH_BLANK_SCREEN = "BlankScreen",
  AUTH_SPLASH_SCREEN = "SplashScreen",
  AUTH_GET_STARTED_SCREEN = "AuthGetStartedScreen",
  AUTH_SELECT_CATEGORY = "AuthSelectCategory",
  ...
  AUTH_LAW_CATEGORY_LAWYER = "AuthLawCategoryLawyer",
  AUTH_SIGN_UP_SOLICITOR = "AuthSignUpSolicitor",
  ...
  CAT_SERVICE_SCREEN = "CatServiceScreen",
